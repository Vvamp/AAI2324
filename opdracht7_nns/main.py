...
if __name__ == "__main__":
    ...
    while True:
        ...
        if passes > 1000:
            ...
            break
    print(round(n.output([0, 0, 0])), " should be (0)")  # All inputs are 0.
    # Only the third input is 1.
    print(round(n.output([0, 0, 1])), " should be (0)")
    # Only the second input is 1.
    print(round(n.output([0, 1, 0])), " should be (0)")
    # The second and third inputs are 1.
    print(round(n.output([0, 1, 1])), " should be (0)")
    # Only the first input is 1.
    print(round(n.output([1, 0, 0])), " should be (0)")
    # The first and third inputs are 1.
    print(round(n.output([1, 0, 1])), " should be (0)")
    # The first and second inputs are 1.
    print(round(n.output([1, 1, 0])), " should be (0)")
    print(round(n.output([1, 1, 1])), " should be (1)")  # All inputs are 1.
